...
if __name__ == "__main__":
    ...
    for model in model_list:
        score_list = []
        score_list.append(int(round(evaluate_use_infeasibility(to_phenotype(MaxSAT_to_genotype(model)), examples_evolutionary, False, 1, False, conjunctive_contexts)[0]*len(examples_evolutionary))))
        score_list.append(int(round(evaluate_use_infeasibility(to_phenotype(MaxSAT_to_genotype(model)), examples_evolutionary, True, 1, False, conjunctive_contexts)[0]*len(examples_evolutionary))))
        score_list.append(int(round(evaluate_use_infeasibility(to_phenotype(MaxSAT_to_genotype(model)), examples_evolutionary, True, 2, False, conjunctive_contexts)[0]*len(examples_evolutionary))))
        score_list.append(int(round(evaluate_use_infeasibility(to_phenotype(MaxSAT_to_genotype(model)), examples_evolutionary, True, 3, False, conjunctive_contexts)[0]*len(examples_evolutionary))))
        score_list.append(int(round(evaluate_use_infeasibility(to_phenotype(MaxSAT_to_genotype(model)), examples_evolutionary, True, 4, False, conjunctive_contexts)[0]*len(examples_evolutionary))))
        score_list.append(int(round(evaluate_use_infeasibility(to_phenotype(MaxSAT_to_genotype(model)), examples_evolutionary, True, 1, True, conjunctive_contexts)[0]*len(examples_evolutionary))))
        score_list.append(int(round(evaluate_use_infeasibility(to_phenotype(MaxSAT_to_genotype(model)), examples_evolutionary, True, 2, True, conjunctive_contexts)[0]*len(examples_evolutionary))))
        score_list.append(int(round(evaluate_use_infeasibility(to_phenotype(MaxSAT_to_genotype(model)), examples_evolutionary, True, 3, True, conjunctive_contexts)[0]*len(examples_evolutionary))))
        score_list.append(int(round(evaluate_use_infeasibility(to_phenotype(MaxSAT_to_genotype(model)), examples_evolutionary, True, 4, True, conjunctive_contexts)[0]*len(examples_evolutionary))))
    ...
    score_list = []
    score_list.append(int(round(evaluate_use_infeasibility(target_model, examples_evolutionary, False, 1, False, conjunctive_contexts)[0] * len(examples_evolutionary))))
    score_list.append(int(round(evaluate_use_infeasibility(target_model, examples_evolutionary, True, 1, False, conjunctive_contexts)[0] * len(examples_evolutionary))))
    score_list.append(int(round(evaluate_use_infeasibility(target_model, examples_evolutionary, True, 2, False, conjunctive_contexts)[0] * len(examples_evolutionary))))
    score_list.append(int(round(evaluate_use_infeasibility(target_model, examples_evolutionary, True, 3, False, conjunctive_contexts)[0] * len(examples_evolutionary))))
    score_list.append(int(round(evaluate_use_infeasibility(target_model, examples_evolutionary, True, 4, False, conjunctive_contexts)[0] * len(examples_evolutionary))))
    score_list.append(int(round(evaluate_use_infeasibility(target_model, examples_evolutionary, True, 1, True, conjunctive_contexts)[0] * len(examples_evolutionary))))
    score_list.append(int(round(evaluate_use_infeasibility(target_model, examples_evolutionary, True, 2, True, conjunctive_contexts)[0] * len(examples_evolutionary))))
    score_list.append(int(round(evaluate_use_infeasibility(target_model, examples_evolutionary, True, 3, True, conjunctive_contexts)[0] * len(examples_evolutionary))))
    score_list.append(int(round(evaluate_use_infeasibility(target_model, examples_evolutionary, True, 4, True, conjunctive_contexts)[0] * len(examples_evolutionary))))
